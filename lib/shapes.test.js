...
test ('Circle', () => {
    ...
    expect(shape.render()).toEqual('<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"> <circle cx="100" cy="100" r="90" fill = "green"/> <text x="100" y="125" font-size="50" text-anchor="middle" fill="white">GHI</text></svg>');
})