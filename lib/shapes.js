...
class Circle extends Shape {
    render() {
        return `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"> <circle cx="100" cy="100" r="90" fill = "${this.colour}"/> <text x="100" y="120" font-size="50" text-anchor="middle" fill="${this.textColour}">${this.title}</text></svg>`
    }
}
